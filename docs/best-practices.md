...
is a fixed 1024 values, and a row group below one vector gets no FSST on its text
columns, which cost 106.4% of their raw bytes at the accepted minimum of 1000
against 54.7% at 1200 (#1017).
