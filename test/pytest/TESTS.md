...
- [40. test_parallel_scan_cost.py: a parallel custom scan must not divide I/O](#40-test_parallel_scan_costpy-a-parallel-custom-scan-must-not-divide-io)
...
## 40. test_parallel_scan_cost.py: a parallel custom scan must not divide I/O
