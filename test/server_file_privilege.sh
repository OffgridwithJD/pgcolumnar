...
entry_points=(
	...
	"read_avro_manifest|read|SELECT * FROM pgcolumnar.read_avro_manifest('$nope')"
	"read_manifest_list|read|SELECT * FROM pgcolumnar.read_manifest_list('$nope')"
	"iceberg_current_snapshot|read|SELECT * FROM pgcolumnar.iceberg_current_snapshot('$nope')"
	"iceberg_data_files|read|SELECT * FROM pgcolumnar.iceberg_data_files('$nope')"
	"iceberg_scan|read|SELECT * FROM pgcolumnar.iceberg_scan('$nope') AS t(id bigint)"
